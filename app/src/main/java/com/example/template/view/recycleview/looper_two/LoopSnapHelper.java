...
public class LoopSnapHelper extends RPagerSnapHelper {
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager lm, int velocityX, int velocityY) {
        ...
        //重写fling操作
        if (lm instanceof RExLoopRecyclerView.LoopLayoutManager) {
        } else {
        ...
        RExLoopRecyclerView.LoopLayoutManager layoutManager = (RExLoopRecyclerView.LoopLayoutManager) lm;
