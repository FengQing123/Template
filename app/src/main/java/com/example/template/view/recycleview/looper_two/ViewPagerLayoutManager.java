package com.example.template.view.recycleview.looper_two;
...
public abstract class ViewPagerLayoutManager extends LinearLayoutManager {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mDistanceToBottom == INVALID_SIZE) {
            mSpaceInOther = (mOrientationHelper.getTotalSpace() - mDecoratedMeasurementInOther) / 2; //中心点宽度
        } else {
            mSpaceInOther = mOrientationHelper.getTotalSpace() - mDecoratedMeasurementInOther - mDistanceToBottom;
        }
    ...
    /**
     * used by to center the current view
     *
    ...
    public int getDistanceToBottom() {
        return mDistanceToBottom == INVALID_SIZE ?
                (mOrientationHelper.getTotalSpace() - mDecoratedMeasurementInOther) / 2 : mDistanceToBottom;
    }
